...
export const TIMELINE: TimelineEntry[] = [
  ...
  // ── Backlog: Building Blocks (parking lot + backlog) ──
  {
    id: 'dnd-2166',
    jiraKey: 'DND-2166',
    type: 'task',
    title: 'Due Date Screen',
    description: 'Calendar/date grid for selecting monthly payment due date. (Parking Lot)',
    status: 'backlog',
  ...
  },
  {
    ...
    description: 'Slider or input for setting downpayment amount with min/max constraints. (Parking Lot)',
    status: 'backlog',
  ...
  },
  {
    ...
    description: 'Date picker for selecting when the downpayment will be paid. (Parking Lot)',
    status: 'backlog',
  ...
  },
  {
    ...
    description: 'Extending the Simulation screen with additional content variants and calculation modes. (Parking Lot)',
    status: 'backlog',
